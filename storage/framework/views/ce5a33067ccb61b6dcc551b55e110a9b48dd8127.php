        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="text">
              ...
              <h3 class='detail'>Age: <?php echo e($data->age); ?></h3>
              <h3 class='detail'>Breed: <?php echo e($data->breed); ?></h3>
              <h3 class='detail'>Personality: <?php echo e($data->personality); ?></h3>
              <h3 class='detail'>Owner Number: <?php echo e($data->number); ?></h3>
              <p>
...
</html><?php /**PATH D:\Laravel\paw2\resources\views/home/description.blade.php ENDPATH**/ ?>